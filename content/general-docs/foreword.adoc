...
{THIS_STANDARD} defines physical material properties and standardizing 3D model structures addressing the need for accurate, standardized 3D assets and material properties to simulate sensor behavior effectively.
