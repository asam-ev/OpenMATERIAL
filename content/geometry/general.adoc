...
Besides reference coordinate frames, _3D assets_ may incorporate other local coordinate frames, see xref:../geometry/object-classes-introduction.adoc[Object classes].
