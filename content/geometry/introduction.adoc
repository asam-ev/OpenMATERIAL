...
* ASAM Open Simulation Interface (OSI) is a specification for interfaces between models and components in a distributed simulation.
  ...
  The asset file (.xoma) of a 3D environment SHALL be linked in ASAM OSI using the https://opensimulationinterface.github.io/osi-antora-generator/asamosi/current/gen/structosi3_1_1GroundTruth.html#a83042861723a4a9e890a53aa98d88858[GroundTruth::model_reference].
