...
A list of use cases examples can be found in the https://asam-ev.github.io/OpenMATERIAL-3D/asamopenmaterial/latest/specification/06_use_cases/use-cases.html[Use Cases] chapter, each highlighting its relevance to the material chapter, the geometry chapter, or both.
...
More information about the file formats is given in in xref:07_geometry/file-format-support.adoc[].
