...
TODO: Add image of right-handed coordinate system with rotation directions

Each 3D model has an individual reference frame. Individual nodes of an
object/asset? may have local coordinate frames.

TODO: Clarify previous paragraph

=== [[sec-World-coordinate-system]]World coordinate system
