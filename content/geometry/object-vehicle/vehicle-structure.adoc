...
NOTE FaKO: Not sure how such a figure should look like.
...
| *x-axis*
| Pointing in the direction of the face normal of the mirror surface
...
image::Grp_Mirror_Blindspot_View.svg[,1100]
...
This group contains an empty element containing the origin of an average passenger of the vehicle (part).
...
This group contains all parts of a rear view mirror mounting of the vehicle (part).
...
The `<seat_idx>` is the index for all seats counting from the front to the rear and from the right to the left (in positive y direction), starting with 0.
