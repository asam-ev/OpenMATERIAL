...
A 3D asset (or **3D Data File**) is a digital entity that includes a 3D geometric representation of an object along with its attributes and metadata. 
