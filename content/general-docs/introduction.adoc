...
* https://asam-ev.github.io/OpenMATERIAL/asamopenmaterial/latest/specification/material/material-index.html[*Material Chapter] Compliance*: Users who focus exclusively on material properties can claim compliance with the Material chapter alone.
