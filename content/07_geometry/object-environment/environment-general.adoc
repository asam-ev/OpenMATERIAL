...
The environment's 3D geometry is structured according to the node structure defined in xref:../07_geometry/object-environment/environment-index.adoc#_model_structure[Model structure].
