...
{THIS_STANDARD} 3D models in glTF format SHALL comply with the official https://registry.khronos.org/glTF/specs/2.0/glTF-2.0.html[glTF specification].
...
Although FBX lacks a formal specification, {THIS_STANDARD} 3D models in FBX format SHALL be compatible with the official https://help.autodesk.com/view/FBX/2020/ENU/?guid=FBX_Developer_Help_welcome_to_the_fbx_sdk_html[AUTODESK FBX SDK].

**USD**

{THIS_STANDARD} 3D models in USD format SHALL comply with the official https://openusd.org/release/index.html[USD specification].
