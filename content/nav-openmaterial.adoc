...
=== 7.3 Object classes
include::geometry/object-classes-introduction.adoc[leveloffset=+3]
...
include::material/material-reflectance-schema.adoc[leveloffset=+2]
...
:sectnums!:
[appendix]
include::appendix/checker-rules.adoc[leveloffset=+1]
