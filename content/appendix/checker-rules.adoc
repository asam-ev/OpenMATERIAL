...
Description:: The wavelength shall be within the range of 1e-09 m to 17,16e-03 m.
...
Description:: The real part of index of refraction (refractive index n) shall be below 0.
...
Description:: The incident elevation angle shall be within the rang of -1.570796 rad to 1.570796 rad.
...
Description:: The BRDF shall not be below 0 (1/sr).
