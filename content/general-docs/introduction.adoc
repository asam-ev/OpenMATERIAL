...
* https://asam-ev.github.io/OpenMATERIAL-3D/asamopenmaterial/latest/specification/index.html[{THIS_STANDARD}® BS 1-0-0 Specification, 2025-MM-DD] (this document, contained in this site)
