...
During simulation a vehicle's Grp_Back_Hitch_Contact_Point and another vehicle's Grp_Front_Hitch_Contact_Point are placed at the same position.
...
This group contains a hitch in the back of the vehicle. It exists on cars and sometimes on trailers for multi-trailer setups.
