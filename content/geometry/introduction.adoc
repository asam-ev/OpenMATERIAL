...
* ASAM OpenDRIVE standardizes the description of road networks. It contains some geometric definitions of the road surface, but mainly targets a semantic description of the road.
