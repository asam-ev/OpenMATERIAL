...
It includes the impact of technologies like 3D modeling tools and 3D engines, as well as specific 3D model formats such as glTF and FBX. 
...
.Use case 9: Simulating energy or signal propagation with _3D assets_ linked to material properties
|===
