...
It shall be a child of `<Grp_Exterior_Dynamic>` if mounted directly to the vehicle body, or a child of `<Grp_Door_Left>` or `<Grp_Door_Right>` if mounted to the door.
...
It shall be a child of `<Grp_Exterior_Dynamic>` if mounted directly to the
vehicle body, or a child of `<Grp_Door_Left>` or `<Grp_Door_Right>` if mounted
to the door.
