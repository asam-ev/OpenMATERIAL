...
|_ Grp_Vehicle_Part_<keyword>_<part_idx> (T)
  |_ Grp_Exterior_<part_idx>
    ...
    |_ Grp_Exterior_Dynamic_<part_idx>
      ...
      |_ Grp_Number_Plate_<part_idx>_<number_plate_idx> (T)
      |_ Grp_Light_Number_Plate_<part_idx>_<number_plate_light_idx> (T)
...
== Grp_Number_Plate_<part_idx>_<number_plate_idx> (T)
...
== Grp_Light_Number_Plate_<part_idx>_<number_plate_light_idx> (T)
