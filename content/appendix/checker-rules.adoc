...
Description:: The density in (kg m^3^) shall be within the range of 0 to 25 (density of Osmium).

==== retroreflection_coefficient_valid_range

UID:: asam.net:xom-mat:1.0.0:xomp.retroreflection_coefficient_valid_range

Description:: The coefficient of retro-reflection in (cd lx^-1^ m^-2^) shall be within the range of 0 to 5000.
