...
* xref:geometry/object-vehicle/vehicle-general.adoc[Vehicle]
* xref:geometry/object-human/human-general.adoc[Human]
* xref:geometry/object-road-network/road-general.adoc[Environment]
