...
The other object class comprises all objects not yet specified by OpenMATERIAL 3D.
Therfore, it includes all objects that aren't specified by other object classes.
