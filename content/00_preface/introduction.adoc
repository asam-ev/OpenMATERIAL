...
A list of use cases examples can be found in the xref:06_use_cases/use-cases.adoc[] chapter, each highlighting its relevance to the material chapter, the geometry chapter, or both.
