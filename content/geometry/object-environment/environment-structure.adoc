...
Grp_Buildings acts as parent to all buildings of an environment. It shares the coordinate system with Grp_Root.
...
Grp_Vegetation acts as parent to all vegetation objects of an environment. It shares the coordinate system with Grp_Root.
...
Grp_Drivable_Area acts as parent to all nodes defining the drivable area of an environment. It shares the coordinate system with Grp_Root.
...
Grp_Sidewalks acts as parent to all nodes defining the sidewalks of an environment. It shares the coordinate system with Grp_Root.
...
Grp_Road_Marks acts as parent to all nodes defining the road marks of an environment. It shares the coordinate system with Grp_Root.
...
Grp_Road_Objects acts as parent to all road objects of an environment. It shares the coordinate system with Grp_Root.
...
Grp_Signals acts as parent to all road objects of an environment. It shares the coordinate system with Grp_Root.
