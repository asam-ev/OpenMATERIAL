...
Description:: The youngs modulus in Pascal (Pa) shall be within the range of 0 to 1.5e12.

==== poissons_ratio_valid_range

UID:: asam.net:xom-mat:1.0.0:xomp.poissons_ratio_valid_range

Description:: The poissons ratio shall be within the range of -1 to 0.5.

==== density_valid_range

UID:: asam.net:xom-mat:1.0.0:xomp.density_valid_range

Description:: The density in (kg m^3^) shall be within the range of 0 to 25.

==== retroreflection_coefficient_valid_range

UID:: asam.net:xom-mat:1.0.0:xomp.retroreflection_coefficient_valid_range

Description:: The coefficient of retroreflection in (cd lx^-1^ m^-2^) shall be within the range of 0 to 5000.
...
Description:: The exit elevation angle in raidans (rad) shall be within the range of -1.570796 to +1.570796.
