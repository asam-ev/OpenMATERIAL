...
|_ Grp_Vehicle_Part_<keyword>_<part_idx> (T)
  |_ Grp_Exterior_<part_idx>
    ...
    |_ Grp_Exterior_Dynamic_<part_idx>
      ...
      |_ Grp_Light_Park_Left_<part_idx>_<position_left_idx> (T)
      |_ Grp_Light_Park_Right_<part_idx>_<position_right_idx> (T)
...
== Grp_Light_Park_Left_<part_idx>_<position_left_idx> (T)
...
== Grp_Light_Park_Right_<part_idx>_<position_right_idx> (T)
