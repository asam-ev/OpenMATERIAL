...
The `<side_mirror_view_left_idx>` index numbers each mirror on the left side, counting from right to left in positive y-direction, and from the front to the rear, starting with 0.
...
The `<side_mirror_view_right_idx>` index numbers each mirror on the right side, counting from right to left in positive y-direction, and from the front to the rear, starting with 0.
...
| *x-axis*
| Collinear with the vehicle part's longitudinal axis, pointing forwards
