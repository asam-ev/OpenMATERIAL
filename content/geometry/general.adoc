...
|ASAM OSI |Moving or stationary object | The origin is in the center of the bounding box. Add half of the height of the asset defined as the maximum z-coordinate in the xref:../geometry/asset-schema.adoc#_bounding-box[bounding box] to the ASAM OpenMATERIAL 3D reference frame.
