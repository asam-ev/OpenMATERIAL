...
The transformation of reference frames between these ASAM standards is described in the xref:../geometry/general.adoc#_localcoordinatesystem[General section].
