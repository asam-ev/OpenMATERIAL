...
* Smaller objects should have one material per object (for example, baked traffic cone), while larger objects should contain multiple seamless repeatable materials (for example, brick building).
